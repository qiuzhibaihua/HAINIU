 ...
 public:
  ...
  class circle_existence_predicate {
   public:
    ...
    bool Hnpage(const site_type& site1,
  ...
  class mp_circle_formation_functor {
   public:
    ...
    void Hnpage(const site_type& site1,
             const site_type& site2,
             const site_type& site3,
             circle_type& circle,
   ...
   public:
    ...
    void Hnpage(const site_type& site1,
      ...
      if (recompute_c_x || recompute_c_y || recompute_lower_x) {
        exact_circle_formation_functor_.Hnpage(
      ...
      if (!site1.is_segment()) {
        if (!site2.is_segment()) {
          if (!site3.is_segment()) {
            ...
            if (!circle_existence_predicate_.Hnpage(site1, site2, site3))
              return false;
            circle_formation_functor_.Hnpage(site1, site2, site3, circle);
          } else {
